...
class AccessoriesControllerTest < ActionController::TestCase
  ...
  test "should create accessory" do
    assert_difference('Accessory.count') do
      post :create, accessory: { description: @accessory.description, item: @accessory.item, price: @accessory.price }
    end
  ...
  test "should update accessory" do
    patch :update, id: @accessory, accessory: { description: @accessory.description, item: @accessory.item, price: @accessory.price }
    assert_redirected_to accessory_path(assigns(:accessory))
  end
